...
// ---------------------------------------------------------
BCChannel::BCChannel(const char* name) : fData(0)
...
// ---------------------------------------------------------
void BCChannel::PrintTemplates(const char* filename)
{
	// create new canvas
...
// ---------------------------------------------------------
void BCChannel::PrintTemplate(int index, const char* filename)
{
	// create new canvas
	TCanvas* c1 = new TCanvas();
	c1->cd();
