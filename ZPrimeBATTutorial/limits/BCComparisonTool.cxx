...
// ---------------------------------------------------------
BCComparisonTool::BCComparisonTool(const char* name) 
{  
	fName = name; 
};

// ---------------------------------------------------------
BCComparisonTool::~BCComparisonTool()
{
...
// ---------------------------------------------------------
void BCComparisonTool::AddContribution(const char* name, TH1D hist)
{
...
// ---------------------------------------------------------
void BCComparisonTool::AddContribution(const char* name, double centralvalue, double uncertainty)
{
	// add name to container
	fNameContainer.push_back(name);
...
// ---------------------------------------------------------
void BCComparisonTool::PrintHistograms(const char* filename)
{
...
// ---------------------------------------------------------
void BCComparisonTool::DrawOverview()
{
...
// ---------------------------------------------------------
void BCComparisonTool::PrintOverview(const char* filename)
{
	// create canvas
	TCanvas* c1 = new TCanvas();
	c1->cd(); 
